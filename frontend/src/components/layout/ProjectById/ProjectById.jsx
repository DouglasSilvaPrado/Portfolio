...
function ProjectById({ projectId }) {
  const project = {
    ...
    description:
      "Sistema de FastFood Desktop para facilitar vendas no atendimento do Cliente",
    type: "Desktop",
    code: "https://github.com/DouglasSilvaPrado/Sistema-de-Fastfood",
    deploy:
      "https://www.linkedin.com/feed/update/urn:li:activity:6891150094536630272/",
    tools: "Java MySQL",
    ...
    <>
      ...
      <div className="container my-5">
        ...
        <div>
          <p>
            {" "}
            <span className="fw-bold">Sobre:</span> {project.description}
          </p>
          <p>
            {" "}
            <span className="fw-bold">Ferramentas Ultilizadas:</span>{" "}
            {project.tools}
          </p>
